...
public class MonthRentDaoImpl implements MonthRentDao{
	...
	public static void main(String[] args) {
		...
		//read
//		System.out.println(new MonthRentDaoImpl().selectLicense("EEE555").getId());
...
//		monthrent.setLicense("EEE555");
//		new MonthRentDaoImpl().update(monthrent);
		
		//delete
//		new MonthRentDaoImpl().delete(new MonthRentDaoImpl().readLicense("safasf"));
