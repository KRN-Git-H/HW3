	...
	public AddMember() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Member member = new Member(Account,Password,Name,Phone,License,Category);
				
				if(new MemberServiceImpl().create(member))
				{
				...
				{
					Tool.alarmMsg(panel, "帳號重覆");
				}
				
			}
		});
		btnNewButton.setBounds(173, 256, 87, 23);
